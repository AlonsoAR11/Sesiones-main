...
import 'package:ejercicio/pages/sesion7/screens/home7screen.dart';
import 'package:ejercicio/pages/sesion7/screens/scroll7w.dart';
import 'package:ejercicio/pages/sesion8/screens/menu8screen.dart';
          ...
          children: [
            ...
            buttonWidget(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const ScrollScreen7()),
                );
              },
            ),
            buttonWidget(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Menu8Screen()),
                );
              },
            ),
          ],
